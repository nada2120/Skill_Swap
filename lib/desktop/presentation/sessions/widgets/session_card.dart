...
class _SessionCardState extends State<SessionCard> {
  ...
  Widget _buildUserImage(double avatarSize) {
    ...
    if (image.startsWith("http") || image.startsWith("https")) {
      return Image.network(
        ...
        height: avatarSize,
        fit: BoxFit.cover,
        errorBuilder: (_, __, ___) => _buildPlaceholder(avatarSize),
      );
    }
  ...
  Widget build(BuildContext context) {
    ...
    final isDesktop = rawWidth > 800;

    // على الديسكتوب نحدد عرض افتراضي ثابت عشان كل الحسابات تتناسب
    final screenWidth = isDesktop ? 420.0 : rawWidth;

    // حجم الأفاتار ثابت ومنطقي
    final avatarSize = isDesktop ? 48.0 : screenWidth * 0.12;
                  ...
                  if (isRequested)
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          color: badgeColor,
                          fontSize: isDesktop ? 12 : screenWidth * 0.03,
                    ...
                    Expanded(
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          ...
                          minimumSize:
                              Size(0, isDesktop ? 44 : screenWidth * 0.11),
                        ),
                        onPressed: isLoading
                            ? null
                            : () {
                    ...
                    listener: (context, state) async {
                      if (state is JoinSessionSuccess) {
                        if (Platform.isWindows ||
                            ...
                            Platform.isLinux) {
                          final url = Uri.parse(
                            "https://meet.ffmuc.net/${widget.session.bookingCode}",
                          );
                    ...
                    builder: (context, state) {
                      ...
                      return GestureDetector(
                        onTap: (_timeRemaining.inSeconds <= 0 && !isJoining)
                            ...
                            : null,
                        child: Container(
                          height: isDesktop ? 44 : screenWidth * 0.11,
...
Widget iconText({
  ...
  return Row(
    children: [
      Icon(icon, size: isDesktop ? 18 : screenWidth * 0.045),
      SizedBox(width: screenWidth * 0.015),
      Flexible(
        child: Text(
